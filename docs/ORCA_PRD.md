...
| Maintainability | Tooling harus konsisten | uv untuk Python (FastAPI & ARQ worker), pnpm untuk frontend |
...
| Docs | README dan .docs menjelaskan setup dengan uv, pnpm, root .env, dan lokasi dataset |
