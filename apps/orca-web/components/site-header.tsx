...
export function SiteHeader() {
  ...
  return (
    <header className="flex h-(--header-height) shrink-0 items-center gap-2 border-b transition-none group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
